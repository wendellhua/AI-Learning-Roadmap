...
```mermaid
graph TD
    subgraph Layer 1: The Bedrock
        A[00. Prerequisites] --> B[01. AI Hardware]
    end
    subgraph Layer 2: The Core
        B --> C[02. LLM Core Concepts]
        C --> D[03. Local Deployment]
    end
    subgraph Layer 3: Interaction
        D --> E[04. Prompt Engineering]
        E --> F[05. RAG & Fine-tuning]
    end
    subgraph Layer 4: Autonomy
        F --> G[06. AI Agents]
        G --> H[07. Ethics & Safety]
    end
    subgraph Layer 5: Impact
        H --> I[08. Future Trends]
        I --> J[09. AI Applications]
    end
...
### ✍️ [04. Prompt Engineering | 提示工程](./04_Prompt_Engineering/)
...
### 🛡️ [07. AI Ethics & Safety | AI 伦理与安全](./07_AI_Ethics_and_Safety/)
